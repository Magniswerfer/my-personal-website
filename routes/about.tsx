...
export default function AboutPage(_props: PageProps) {
    ...
    const publications: Publication[] = [
        {
            title: "Analyzing Developer Productivity in Software Projects: A Mixed-Methods Approach",
            ...
            abstract: "This paper presents a comprehensive analysis of developer productivity metrics..."
        },
        {
            title: "Master's Thesis: Improving Web Application Performance Through Static Analysis",
            authors: ["Magnus H. Kaspersen"],
            venue: "IT University of Copenhagen",
            date: "2022",
            type: "thesis",
            link: "https://example.com/thesis",
            abstract: "This thesis explores novel approaches to improving web application performance..."
        },
    ...
    return (
        ...
        <PageHeader 
        title="About Me"
        subtitle="Software Developer, Writer, and Technology Enthusiast"
        />
        ...
        Hello! I'm Magnus, a software developer based in Denmark with a passion for building 
            modern web applications. I specialize in frontend development with React and TypeScript, 
        but I'm also experienced with various backend technologies.
            </p>
        <p class="text-lg text-gray-600 leading-relaxed">
        When I'm not coding, I enjoy writing about technology and software development on my blog. 
            I'm particularly interested in web performance, developer experience, and building intuitive user interfaces.
            </p>
        </div>
        </div>
        </div>
        ...
        {(['conference', 'journal', 'thesis', 'other'] as const).map(type => {
            const typePublications = publications.filter(p => p.type === type);
            ...
            return (
                ...
                {type === 'other' ? 'Other Publications' : `${type}s`}
                </h3>
                <div class="space-y-6">
                {typePublications.map((pub, index) => (
                    ...
                    {pub.doi && (
                        ...
                        >
                        <CustomIcon name="globe" size={16} className="mr-1" />
                        DOI
                        </a>
                    )}
                    {pub.link && (
                        ...
                        class="text-indigo-600 hover:text-indigo-800 flex items-center"
                        >
                        <CustomIcon name="arrow-right" size={16} className="mr-1" />
                        View Publication
                        </a>
                    )}
                    </div>
